        ...
        <section class="row mx-0 my-2 align-items-center flex-column">
          ...
          <div class="row mx-0">
            <div class="card" style="width: 18rem;">
              ...
              <p class="lead col-12 col-sm-11 px-0">Творческие способности — способности человека принимать творческие решения, понимать, принимать и создавать принципиально новые идеи</p>
            </div>
            <div class="card" style="width: 18rem;">
              <div class="card-body">
              ...
              <p class="lead col-12 col-sm-11 px-0">Отлично зарекомендовавшие себя frameworks, удобные и надежные CMS и базы данных.</p>
            </div>
            <div class="card" style="width: 18rem;">
              <div class="card-body">
                <svg width="60" height="60">
              ...
              <p class="lead col-12 col-sm-11 px-0">Прекрасно сработавшаяся и сплоченная команда профессионалов.</p>
            </div>
          </div>
        </section>
      </div>
