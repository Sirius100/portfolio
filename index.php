...
<html lang="ru-RU">
  ...
  <body>
    ...
    <div class="container-fuild">
      <div class="container">
        <div class="row mx-0 justify-content-end my-2">
          <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Contact</a>
    ...
    <div class="container-fuild">
      <div class="container">
        <div class="row mx-0 h-100 align-items-center">
          <div class="col-sm-12 col-md-5 home_foto"></div>
          <div class="col-sm-12 col-md-7 home_studio">
            <p class="lead">Студия WEB разработки<br><span>Leading</span></p>
            ...
            <p class="lead mb-0">
              <button class="btn btn-secondary btn-lg">Оставить заявку</button><br><span>Мы открыты для плодотворного сотрудничества!</span>
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="container-fuild">
      <div class="container">
        <section class="row mx-0 my-2 align-items-center flex-column">
          <h6 class="display-6">Наши помощники</h6>
          <h5 class="display-5">Креативное мышление и современные технологии</h5>
          <div class="row justify-content-between">
            <div class="col-12 col-sm-4">
              <div class="card">
                <div class="card-body">
                  <svg width="55" height="55" viewbox="-10 0 80 60" baseProfile="full">
                    <g>
                ...
                <h5 class="display-5">Креативность</h5>
                <p class="lead col-12 col-sm-10 px-0">Творческие способности — способности человека принимать творческие решения, понимать, принимать и создавать принципиально новые идеи.</p>
              </div>
            </div>
            <div class="col-12 col-sm-4">
              <div class="card">
                ...
                <h5 class="display-5">Технологии</h5>
                <p class="lead col-12 col-sm-10 px-0">Отлично зарекомендовавшие себя frameworks, удобные и надежные CMS и базы данных.</p>
              </div>
            </div>
            <div class="col-12 col-sm-4">
              <div class="card">
                ...
                <h5 class="display-5">Команда</h5>
                <p class="lead col-12 col-sm-10 px-0">Прекрасно сработавшаяся и сплоченная команда профессионалов.</p>
              </div>
            </div>
          </div>
        </section>
    ...
    <div class="container-fuild">
      <div class="container py-2">
        <div class="row">
          <div class="col-12 col-sm-6 timemenedg_foto"></div>
          <div class="col-12 col-sm-6 timemenedg_notebook"><img class="col-10 col-sm-6" src="src/img/notebook.jpg">
            <p>
              <h3 class="display-5">The 2 Secrets to Time Management</h3>
            </p><br>
            <p>
              <h6 class="display-6">Phasellus scelerisque sed leo quis gravida. Fusce lobortis libero ut arcu blandit pharetra.</h6>
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="container-fuild">
      <div class="container px-0">
        <div class="row mx-0 justify-content-between my-3">
          <div class="col-12 col-sm-4">
            <div class="pers-1"></div>
          </div>
          <div class="col-12 col-sm-4">
            <div class="pers-2"></div>
          </div>
          <div class="col-12 col-sm-4">
            <div class="pers-3"></div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-12 col-sm-6 px-0 left_column">
            <div class="left_column_container">
              ...
              <button class="btn btn-outline-dark">Заказать дизайн</button>
            </div>
          </div>
    ...
    <div class="container-fuild">
      <div class="container">
        <div class="row mx-0 justify-content-around">
          <div class="address_office col-12 col-sm-4">
            <div class="address_office_svg"><span>Headline</span>
              <p>Sample footer text</p>
            </div>
          </div>
          <div class="number_phono col-12 col-sm-4">
            <div class="number_phono_svg"><span>Headline</span>
              <p>Sample footer text</p>
            </div>
          </div>
          <div class="email col-12 col-sm-4">
            <div class="email_svg"><span>Headline</span>
              <p>Sample footer text</p>
            </div>
          </div>
        </div>
